...
const SingleAccordion = ({ id, title, content, className }) => {
  return (
    <AccordionItem value={id} className={`w-full  ${className}`}>
      ...
      <AccordionContent className="text-[1.25vw] text-justify tracking-[0.5px] leading-[1.4] space-y-[1.5vw] w-full  mobile:w-full mobile:text-[4vw] mobile:space-y-[4vw] tablet:text-[2.7vw] tablet:w-[90%] pt-[2vw] mobile:leading-[1.6]">
        {content}
      </AccordionContent>
